...
import { Upload, Download, Eye, Lock, FileText, Image as ImageIcon, AlertCircle, CheckCircle, Loader } from 'lucide-react';
...
const ImageStego = () => {
  ...
  const handleEmbed = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/image/embed', formData, {
        headers: {
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/image/extract', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-lg">
          Hide and extract secret data in images using LSB (Least Significant Bit) technique
        </p>
      </div>
        ...
        <div className="card">
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              {mode === 'embed' ? 'Cover Image' : 'Stego Image'}
            </label>
              ...
              >
                {coverImage ? (
                  ...
                  <div className="flex flex-col items-center space-y-2 text-gray-500">
                    ...
                    <span className="text-sm">PNG, BMP, TIFF supported</span>
                  </div>
                )}
              </button>
            </div>
